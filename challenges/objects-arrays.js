...
const unisWithUni = graduates.filter((un) => {
  return un.university.includes('Uni');
});
...
*/
let populationTotal = zooAnimals.reduce((sum, popvalue) => {
  return sum + popvalue.population;
},0);
